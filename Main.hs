...
main :: IO ()
main = play (InWindow "Dungeon Crawler" (800, 800) (10, 10)) black 1 (World "start" 0.0 (InternalState (Character 0 0 0 0 0 0 0) (Character 10 10 5 0 0 0 1) 1) "") render handleKeys update
